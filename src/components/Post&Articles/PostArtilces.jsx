...
const posts = [
  {
    ...
    date: '22 June 2023',
    author: 'Admin',
    description: 'Explore how telehealth services are transforming healthcare, making medical consultations more accessible and convenient for families.',
  },
  {
    id: 2,
    category: 'Hospital',
    ...
    date: '22 June 2023',
    author: 'Admin',
    description: 'Discover how Doccure simplifies clinic visits, reducing wait times and ensuring a seamless healthcare experience for patients.',
  },
  {
    id: 3,
    category: 'Doctor',
    ...
    date: '22 June 2023',
    author: 'Admin',
    description: 'Learn about the advantages of online doctor booking, from saving time to getting immediate medical consultations anytime, anywhere.',
  },
];
            ...
            {posts.map((post) => (
              <div key={post.id} className="bg-white rounded-lg shadow-md overflow-hidden group ">
                <div className="relative"> 
                  <img src={post.image} alt={post.title} width={500} height={300} className="w-full h-56 object-cover group-hover:transition-transform transform duration-75 hover:scale-105" />
                ...
                <div className="p-5">
                  ...
                  <div className="flex items-center justify-between mt-4  text-gray-500 text-sm">
                    <p className="font-semibold text-black hover:text-blue-500 flex items-center gap-3 cursor-pointer">Read More <span> <FaArrowRightLong /></span></p>
