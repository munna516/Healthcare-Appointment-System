...
export default function EmergencyContact() {
    ...
    return (
        <section className="py-12 bg-blue-50">
            ...
            <div className="container  mx-auto px-4 flex flex-col lg:flex-row items-center md:justify-start md:items-start justify-between">
                {/* Left Side */}
                ...
                <div className="lg:w-1/2 flex justify-center mt-8 md:mt-0">
                    ...
                    <img src={image} alt="Emergency Contact" width={500} height={400} className="object-contain" />
                </div>
            </div>
        </section>
    );
